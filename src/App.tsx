...
function Configuracoes() {
  return (
    <>
      ...
      <div className="settings-panels"><section className="page-card"><h2>Fluxo Financeiro</h2><div className="status-row"><span>Aprovação de despesas</span><strong>Ativa</strong></div><div className="status-row"><span>Classificação contábil</span><strong>Opcional</strong></div><div className="status-row"><span>Recebimento chega pronto à Tesouraria</span><strong>Ativo</strong></div></section><section className="page-card"><h2>Serviços Firebase</h2><div className="status-row"><span>Authentication</span><strong className="success-text">Ativo</strong></div><div className="status-row"><span>Firestore</span><strong className="success-text">Ativo</strong></div><div className="status-row"><span>Hosting</span><strong className="success-text">Ativo</strong></div><div className="status-row"><span>Storage</span><strong className="success-text">Blaze ativo · validar bucket</strong></div></section></div>
    </>
  )
}
